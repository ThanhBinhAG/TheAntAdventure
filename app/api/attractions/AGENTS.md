...
## Contents
- `route.ts` — POST/PATCH gọi RPC transaction lưu Attraction và liên kết ảnh; DELETE xóa địa điểm.
...
- Mọi lỗi khi ghi photo link phải rollback Attraction aggregate.
