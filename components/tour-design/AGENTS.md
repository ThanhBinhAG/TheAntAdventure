...
## Contents
- `TourDesignPage.tsx` — wizard orchestration (URL slug still `tourdesign`); product, draft, outline, gallery reads use BFF endpoints; customers/leads via [`useTourDesignCrmContext`](../../hooks/useTourDesignCrmContext.ts); saves use the Tour Design BFF
