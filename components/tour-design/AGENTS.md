...
## Contents
- `TourDesignPage.tsx` — wizard orchestration (URL slug still `tourdesign`); product, draft, outline, gallery and hotel reads use BFF endpoints; customers/leads via [`useTourDesignCrmContext`](../../hooks/useTourDesignCrmContext.ts); Outline workflow and saves use the Tour Design BFF
