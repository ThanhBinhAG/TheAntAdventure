...
- CRM UI appearance is per-browser (`localStorage` keys `crm.theme`, `crm.fontSize`); mount `ThemeBootstrap` in the CRM shell and use `useTheme` in Settings.
