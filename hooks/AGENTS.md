...
- `useCreateContract` / `useUpdateContract` are BFF-first on `/contracts`; store mirror under `withoutAutoSyncAsync` with rollback on update failure.
