...
export const SALES: Record<AppLanguage, Record<string, string>> = {
  en: {
    ...
    paxSuffix: 'pax',
    searchPlaceholder: 'Search leads, customers, tours…',
    filterAll: 'All',
    filterFollowUpToday: 'Follow-up today',
    filterFollowUpWeek: 'Follow-up this week',
    filterOverdue: 'Overdue',
    filterByTravelMonth: 'Travel month',
    filterFollowUpRange: 'Follow-up range',
    ...
    showLess: 'Show less',
    emptyStage: 'No leads',
    emptyStagesHidden: 'empty stages',
    showEmptyStages: 'Show empty',
    hideEmptyStages: 'Hide empty',
    noResults: 'No matching leads found',
    noResultsHint: 'Try another search or clear filters to see all leads in the pipeline.',
    noLeadsYet: 'No leads in the pipeline yet',
    noLeadsYetHint: 'Add a client to create your first lead and start tracking the deal.',
    clearFilters: 'Clear filters',
    groupByTravelMonth: 'Group by travel month',
    followUp: 'Follow-up',
    travelMonthUndetermined: 'Undetermined',
    leadCount: 'leads',
  },
  vi: {
    ...
    aiEmailSignature: 'The Ant Adventures',
    paxSuffix: 'khách',
    searchPlaceholder: 'Tìm lead, khách hàng, tour…',
    filterAll: 'Tất cả',
    filterFollowUpToday: 'Follow-up hôm nay',
    filterFollowUpWeek: 'Follow-up tuần này',
    filterOverdue: 'Quá hạn',
    filterByTravelMonth: 'Tháng đi',
    filterFollowUpRange: 'Khoảng follow-up',
    filterStage: 'Mọi giai đoạn',
    followUpFrom: 'Từ',
    followUpTo: 'Đến',
    showMore: 'thêm',
    showLess: 'Thu gọn',
    emptyStage: 'Chưa có lead',
    emptyStagesHidden: 'giai đoạn trống',
    showEmptyStages: 'Hiện trống',
    hideEmptyStages: 'Ẩn trống',
    noResults: 'Không tìm thấy lead phù hợp',
    noResultsHint: 'Thử tìm kiếm khác hoặc xóa bộ lọc để xem toàn bộ pipeline.',
    noLeadsYet: 'Chưa có lead nào trong pipeline',
    noLeadsYetHint: 'Thêm khách hàng để tạo lead đầu tiên và bắt đầu theo dõi deal.',
    clearFilters: 'Xóa bộ lọc',
    groupByTravelMonth: 'Nhóm theo tháng đi',
    followUp: 'Follow-up',
    travelMonthUndetermined: 'Chưa xác định',
    leadCount: 'lead',
  },
};
