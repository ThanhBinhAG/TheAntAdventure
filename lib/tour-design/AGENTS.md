...
- `tour-design-repository.ts` — Server-only repository for Supabase reads, idempotent Sales handoff acknowledgement, and atomic RPC saves of tour drafts and outlines.
