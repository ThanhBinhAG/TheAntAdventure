...
- `tour-design-repository.ts` — Server-only repository for reference data, idempotent Sales handoff acknowledgement, and atomic RPC saves/workflow transitions for drafts, Leads, and Comms.
