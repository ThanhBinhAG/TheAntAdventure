-- ============================================================
--  Baseline v5 schema (CLI migration 20260101000000)
--  Source of truth for fresh installs via: npm run db:push
--  SQL Editor equivalent: supabase/schema.sql (keep in sync)
--
--  Existing remote that already has this schema (do NOT re-push):
--    npm run db:bootstrap
--    # or: bash scripts/supabase-db.sh repair-applied 20260101000000
-- ============================================================
