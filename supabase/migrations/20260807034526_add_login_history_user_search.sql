...
-- Thay RPC cũ bằng phiên bản có thêm filter_user_query.
-- Drop đúng signature cũ, trong cùng transaction nên không tạo thời điểm hở.
drop function public.list_auth_login_events(
  integer,
  integer,
  uuid,
  inet,
...
declare
  ...
  -- Chuẩn hoá chuỗi trống thành null để không làm kết quả bị lọc nhầm.
